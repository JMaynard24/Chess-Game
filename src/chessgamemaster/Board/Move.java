package chessgamemaster.Board;

import chessgamemaster.Board.Board.Builder;
import chessgamemaster.Pieces.Pawn;
import chessgamemaster.Pieces.Piece;
import chessgamemaster.Pieces.Rook;
...
public abstract class Move {
    ...
    public int hashCode() {
        ...
        result = prime * result + this.movedPiece.getPiecePosition(); //is first move or not
        return result;
    }
    ...
    public static final class PieceMove extends Move {
        ...
        public PieceMove(final Board board,
                         final Piece movedPiece,
